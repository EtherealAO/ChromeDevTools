namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Media
{
	...
	public class PlayerError
	{
		...
		/// <summary>
		/// Gets or sets Code is the numeric enum entry for a specific set of error codes, such
		...
		/// <summary>
		/// Gets or sets Errors potentially have a root cause error, ie, a DecoderError might be
