...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.WebAuthn
{
	...
	public class VirtualAuthenticatorOptions
	{
		...
		/// <summary>
		/// Gets or sets If set to true, the authenticator will support the minPinLength extension.
		...
		/// <summary>
		/// Gets or sets If set to true, the authenticator will support the prf extension.
