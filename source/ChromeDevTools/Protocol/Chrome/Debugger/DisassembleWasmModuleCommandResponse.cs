...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Debugger
{
	...
	{
		/// <summary>
		/// Gets or sets For large modules, return a stream from which additional chunks of
		...
		/// <summary>
		/// Gets or sets The offsets of all function bodies, in the format [start1, end1,
