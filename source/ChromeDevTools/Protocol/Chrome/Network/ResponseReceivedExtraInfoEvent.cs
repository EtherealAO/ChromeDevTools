...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Network
{
	...
	public class ResponseReceivedExtraInfoEvent
	{
		...
		/// <summary>
		/// Gets or sets The cookie partition key that will be used to store partitioned cookies set in this response.
		/// Only sent when partitioned cookies are enabled.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public string CookiePartitionKey { get; set; }
		/// <summary>
		/// Gets or sets True if partitioned cookies are enabled, but the partition key is not serializeable to string.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
